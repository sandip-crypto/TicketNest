...
const ConcertTicket = () => {
    ...
    const fetchTransaction = async () => {
      try {
        ...
        const response = await axios.get(
          `/api/v1/concert-transaction/single-concert-transaction/${id}`
        );
  ...
  const ticketData = {
    ...
    ConcertId: transaction.concert._id,
    ConcertTitle: transaction.concert.title,
            ...
            <div className="relative p-6 text-white bg-teal-600">
              ...
              <div className="relative">
                ...
                <p className="text-teal-100">
                  {" "}
                  Genre: {transaction.concert.genre}
                </p>
              </div>
            </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="font-medium">
                        {new Date(
                          transaction.concert.availableShows[0].date
                        ).toLocaleDateString()}
                      </p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="font-medium">
                        {transaction.concert.availableShows[0].time}
                      </p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="font-medium">
                        {transaction.concert.address},{" "}
                        {transaction.concert.city}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="pt-4 border-t">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="font-medium">{transaction.ticketType}</p>
                    </div>
                    <div>
